...
Java Developer
Created On 15/09/2024 21:40
@Last Modified 15/09/2024 21:40
Version 1.0
*/
...
@SpringBootTest
public class StatementAlgorithmInsertTest {
    ...
    void contextLoads() {
        ...
        StatementAlgorithmDto dto = new StatementAlgorithmDto();
        dto.setType("ucen1");
        dto.setLogic("ucengoe");
        dto.setStatus(1);
        dto.setCommand("Sample ucen1");
        statementAlgorithmDao.save(dto);
